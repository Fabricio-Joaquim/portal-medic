...
export const MobileBar = () => {
    ...
    return (
        <aside className="relative fixed lg:hidden justify-center w-screen bg-white border border-gray-100 rounded-lg dark:bg-gray-700 dark:border-gray-600">
            <div className="sticky bottom-0 left-0 z-50 w-full h-18 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
